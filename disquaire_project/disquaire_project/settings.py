...
SECRET_KEY =os.environ.get('SECRET_KEY','icr7$-vjj@!eqy59d=2*k&e&64j@duw&wogx_@bt20-r4t)_z!')
# clé secrète prodution: "4Nd&<)\\^pc}skI#&[];p'8X4"
...
ALLOWED_HOSTS = ['disquaire_RB.herokuapp.com']
